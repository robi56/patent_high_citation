...
feature_path="features_patent_bert/features_H04_3y_10p_patent_bert.pt"
edge_path='edges/edges_H04_3y_10p_d2v_t0.6_f29.86.pt'
label_path="labels/H04_3y_10p.tsv.pt"
resutl_path="results/GNN_explanation.txt"
dim =1024 
lr =0.0001 
nepochs =10 
model ="GCN" 
test_index_path= "test_indexs_future/H04_3y_10p.tsv_test_indexs_2.pt"
edge_factor=-1

try:
   os.mkdir("figures_H04/")
...
for node_index in selected_1_nodes:
    ...
    path = os.path.join("figures", 'gcn_'+'features_H04_3y_10p_patent_bert_'+'label_1_'+str(node_index)+".png")
    info_path = os.path.join("figures",'gcn_'+'features_H04_3y_10p_patent_bert_'+'label_1_'+str(node_index)+".txt")
...
for node_index in selected_0_nodes:
    explanation = explainer(data.x, data.edge_index, index=node_index)
    print(f'Generated explanations in {explanation.available_explanations}')
    path = os.path.join("figures", 'gcn_'+'features_H04_3y_10p_patent_bert_'+'label_0_'+str(node_index)+".png")
    info_path = os.path.join("figures",'gcn_'+'features_H04_3y_10p_patent_bert_'+'label_0_'+str(node_index)+".txt")
    explanation.visualize_feature_importance(path, top_k=10)
    print(f"Feature importance plot has been saved to '{path}'")
