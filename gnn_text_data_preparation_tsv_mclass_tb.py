...
def main(args):
    ...
    missed_abstract=0
    missed_claims=0
    # Calculate the number of elements to select (50% of the list)
    num_elements_to_select = int(len(middle_patent_ids) * 0.5)

    # Randomly select 50% of elements
    middle_patent_ids = random.sample(middle_patent_ids, num_elements_to_select)
    ...
    missed_abstract=0
    missed_claims=0
    num_elements_to_select = int(len(bottom_patent_ids) * 0.5)

    # Randomly select 50% of elements
    bottom_patent_ids = random.sample(bottom_patent_ids, num_elements_to_select)
